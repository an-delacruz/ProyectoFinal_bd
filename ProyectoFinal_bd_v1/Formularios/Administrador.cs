...
namespace ProyectoFinal_bd_v1.Formularios
{
    public partial class Administrador : Form
    {
        ...
        private void pnlSuperiorFondo_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
        ...
        private void btnReportesViajes_Click(object sender, EventArgs e)
        {
            ReportViewers.RepViajes miRep = new ReportViewers.RepViajes();
            miRep.Show();
            this.Hide();
        }
    }
